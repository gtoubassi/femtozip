...
public class TripleNibbleFrequencyCodeModel implements ArithCodeModel {
    ...
    public TripleNibbleFrequencyCodeModel(FrequencyCodeModel literalLengthModel,
    ...
    public TripleNibbleFrequencyCodeModel(DataInputStream in) throws IOException {
